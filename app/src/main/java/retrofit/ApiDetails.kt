...
import com.example.crm.pending.ProjectListResponse
...
interface ApiDetails {
    ...
    fun getpendingList(@Body pendingRequest : PendingRequest) : Call<ProjectListResponse>
...
//
//    @POST("datamap.svc/rest/UpdateSurveyImageDetail")
//    fun updatePendingListDetails(@Body listModel: ProjectListData): Call<ProjectListData>
}